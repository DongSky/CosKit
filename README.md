...
- [Boogu-Image](https://github.com/boogu-project/Boogu-Image) — Boogu 图像编辑模型上游项目，CosKit 的本地模型修图能力基于其 Boogu-Image-0.1-Edit 模型（经 [boogu_image_edit_model_parallel_server](https://github.com/DongSky/boogu_image_edit_model_parallel_server) 封装为 OpenAI 兼容服务）
- [Tauri](https://github.com/tauri-apps/tauri) — 跨平台应用框架，CosKit 基于 Tauri 2 构建桌面端与移动端
